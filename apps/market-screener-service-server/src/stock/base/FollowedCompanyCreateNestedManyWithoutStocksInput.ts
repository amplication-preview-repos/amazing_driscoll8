...
@InputType()
class FollowedCompanyCreateNestedManyWithoutStocksInput {
...
export { FollowedCompanyCreateNestedManyWithoutStocksInput as FollowedCompanyCreateNestedManyWithoutStocksInput };
